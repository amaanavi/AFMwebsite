...
export const famousGames = [
  {
    ...
    moves: [
      ...
      "b5", "Nge2", "Nbd7", "Bh6", "Bxh6", "Qxh6", "Bb7", "a3", "e5", "O-O-O",
      "Qe7", "Kb1", "a6", "Nc1", "O-O-O", "Nb3", "exd4", "Rxd4", "c5", "Rd1",
      "Nb6", "g3", "Kb8", "Na5", "Ba8", "Bh3", "d5", "Qf4+", "Ka7", "Rhe1",
      "d4", "Nd5", "Nbxd5", "exd5", "Qd6", "Rxd4", "cxd4", "Re7+", "Kb6",
  ...
  },
  {
    ...
    startPly: 76,
    moves: [
      "d4", "Nf6", "c4", "e6", "Nf3", "d5", "Nc3", "c6", "e3", "Nbd7", "Qc2",
      "Bd6", "Bd3", "O-O", "O-O", "Re8", "e4", "dxc4", "Bxc4", "e5", "Rd1",
      "exd4", "Nxd4", "Qc7", "g3", "Ne5", "Be2", "Bh3", "Bg5", "Neg4", "Bf1",
      "Bxf1", "Rxf1", "Be5", "Nf5", "g6", "Nh6+", "Nxh6", "Bxh6", "Ng4", "Bd2",
      "Rad8", "Kg2", "Qe7", "h3", "Nf6", "Rfe1", "Qc5", "Rad1", "Qc4", "Bg5",
      "Rxd1", "Rxd1", "b5", "f3", "b4", "Qe2", "Qe6", "Na4", "Qxa2", "Qc2",
      "c5", "Nxc5", "Rc8", "Rd2", "Qa5", "Be3", "Qc7", "Qd3", "Qc6", "Kf2",
      "Bc7", "Na6", "Rd8", "Nxb4", "Qe6", "Qxd8+", "Bxd8", "Rxd8+", "Kg7",
      "Bd4", "Kh6", "g4", "Nd7", "Nd5", "f5", "Rh8", "fxe4", "f4", "Nf8",
      "g5+", "Kh5", "Nf6+", "Kh4", "Nxh7", "e3+", "Bxe3",
    ],
  },
  {
    ...
    startPly: 45,
    moves: [
      "d4", "Nf6", "Nf3", "g6", "c4", "Bg7", "e3", "O-O", "Be2", "c5", "d5",
      "e6", "Nc3", "exd5", "cxd5", "d6", "O-O", "Bg4", "h3", "Bxf3", "Bxf3",
      "Nbd7", "Qc2", "a6", "a4", "c4", "Be2", "Rc8", "a5", "Rc5", "Qa4", "Re8",
      "Rd1", "Ne4", "Nxe4", "Rxe4", "Bd2", "f5", "Qa3", "Rb5", "Rab1", "Rb3",
      "Qa2", "Nc5", "f3", "c3", "fxe4", "cxd2", "Bc4", "Qg5", "Bxb3", "Qxe3+",
      "Kh1", "Nxe4", "Rf1", "Be5",
    ],
  },
  {
    ...
    moves: [
      ...
      "Bb6", "e5", "Ne4", "Bd5", "Nxc3", "Nxc3", "dxc3", "Bg5", "Ne7", "O-O",
      "h6", "Bh4", "O-O", "Re1", "Qe8", "Bb3", "a5", "Bf6", "a4", "Bc4", "Ng6",
      "Qd3", "d5", "exd6", "Be6", "Qxg6", "fxg6", "Rxe6", "Qf7", "Bxc3", "Kh8",
      "Re4", "Qf5", "Re7", "Rg8", "Bxg8", "Rxg8", "dxc7", "Qc2", "Be5", "Bxf2+",
      "Kh1", "Bb6", "h3", "Kh7", "Re1", "a3", "Kh2", "g5", "Nd4", "Qc4", "Nf5",
      "Qxb4", "Rc1", "Kg6", "Rxg7+", "Kxf5", "Rxg8", "Bxc7", "Bxc7", "Qb2",
      "Rc5+", "Ke4", "Rd8",
    ],
  },
  {
    ...
    startPly: 67,
    moves: [
      "c4", "e6", "Nc3", "d5", "d4", "c5", "cxd5", "exd5", "Nf3", "Nc6", "g3",
      "Nf6", "Bg2", "cxd4", "Nxd4", "Bc5", "Nb3", "Bb6", "Na4", "O-O", "Nxb6",
      "axb6", "Nd4", "Re8", "b3", "Bg4", "f3", "Bd7", "e3", "h5", "O-O", "h4",
      "g4", "Nh7", "h3", "Qf6", "Bb2", "Qh6", "Nc2", "Qg6", "Qd2", "Rad8",
      "Nd4", "Ng5", "Rad1", "Bc8", "Ne2", "Ne6", "b4", "f5", "a3", "Qh6", "f4",
      "fxg4", "hxg4", "Nc7", "Bf3", "Bxg4", "Bxg4", "Qg6", "Kh2", "Qxg4",
      "Rg1", "Qf3", "Rxg7+", "Kf8", "Nd4", "Nxd4", "Qxd4", "Rd6", "Rdg1",
      "h3", "Rf7+", "Kxf7", "Qg7+", "Ke6", "Rg6+",
    ],
  },
];
...
export const travelPhotos = [
  ...
  { src: "/travel/travel-05.jpg", alt: "Standing in front of a large mural of a boy with fireflies" },
  ...
  { src: "/travel/travel-10.jpg", alt: "Flares and smoke in the stands at a night soccer match" },
  { src: "/travel/travel-11.jpg", alt: "Walking a dog along a forest canal path" },
  ...
  { src: "/travel/travel-15.jpg", alt: "Bougainvillea flowers climbing a staircase railing" },
